...
from talelio_backend.tests.constants import EMAIL_TALEL, PASSWORD, USERNAME_TALEL
...
def create_user_project_helper(uow: FakeUnitOfWork,
    ...
    return create_user_project(uow, username, title, body)  # type: ignore
