...
from talelio_backend.shared.exceptions import AccountRegistrationError


def register_account(uow: UnitOfWork, email: str, password: str,
                     username: str) -> Dict[str, Dict[str, Union[str, int]]]:
...
# TODO: Uncomment when SQL refactoring is done
